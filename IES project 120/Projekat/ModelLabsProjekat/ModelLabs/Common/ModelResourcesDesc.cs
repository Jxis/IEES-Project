...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{
			// poziva se po ovim redosledom, po dijagramu se vidi sta treba pre
			// sadrzi sve konkretne klase 
		...
		{
			// stavljamo model codove svih listi referenci 
			notSettablePropertyIds.Add(ModelCode.IDOBJ_GID); // uvek
			...
			notSettablePropertyIds.Add(ModelCode.POWERSYSTEMRESOURCE_OUTAGESCHEDULES); // ispravila u dijagramu 
